...
class _ClientPageState extends State<ClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget tripPhotos = StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('documents').where('uid'== widget.title).orderBy('timestamp', descending: true).snapshots().where('uid' == ),
                  ...
                  return Padding(
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            DateTime dateToTimeStamp =
                                tripPhotos[index]['timestamp'].toDate();
                            return SizedBox(
                              height: 50,
                              width: 300,
                              child: InkWell(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    tripPhotos[index]['fileName'],
                                    style: const TextStyle(color: Colors.white),
                                  ),
                                  subtitle: Padding(
                                      padding: EdgeInsets.only(top: 5),
                                      child: Text(
                                        dateToTimeStamp.toString(),
                                        style: TextStyle(
